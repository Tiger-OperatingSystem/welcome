...
case $1 in
    ...
    removerPacote "clamtk" | yad --progress --no-cancel --no-buttons --borders=32 --fixed --center --undecorated --width=380 --button="Ok":0 --modal \
    ...
    msoffice)
        ...
        yad --modal --info --borders=32 --fixed --center --undecorated --width=380 --button="Ok":0   --text="O MS Office foi removido com sucesso!"
    } || {
        yad --modal --error --borders=32 --fixed --center --undecorated --width=380 --button="Ok":0   \
        --text="Não foi possível concluir a remoção...\nPor favor, tente novamente!" 
    }
    ;;
    ...
    googledocs)
        ...
        yad --modal --info  --borders=32 --fixed --center --undecorated --width=380 --button="Ok":0   --text="O Google Docs foi removido com sucesso!\n" 
    } || {
        yad --modal --error  --borders=32 --fixed --center --undecorated --width=380 --button="Ok":0   \
        --text="Não foi possível concluir a remoção...\nPor favor, tente novamente!"
    }
    ...
    gcontacts)
        pkexec env DISPLAY=$DISPLAY XAUTHORITY=$XAUTHORITY rm ${WEBAPP_TARGET}/bin/gcontacts ${WEBAPP_TARGET}/applications/gcontacts.desktop && {
            rm -r ~/.gcontacts
            yad --info --borders=32 --fixed --center --undecorated --text="O webapp Google Contacts foi removido com sucesso!"  --width=380 --button="Ok":0
        } || {
            yad --error --borders=32 --fixed --center --undecorated --text="Não foi possível concluir a remoção do webapp!" --modal   --width=380 --button="Ok":0
        }
        exit
        ;;
    ...
    gcalendar)
        pkexec env DISPLAY=$DISPLAY XAUTHORITY=$XAUTHORITY rm ${WEBAPP_TARGET}/bin/gcalendar ${WEBAPP_TARGET}/applications/gcalendar.desktop && {
            rm -r ~/.gcalendar
            yad --info --borders=32 --fixed --center --undecorated --text="O webapp Google Calendar foi removido com sucesso!" --modal   --width=380 --button="Ok":0
        } || {
            yad --error --borders=32 --fixed --center --undecorated --text="Não foi possível concluir a remoção do webapp!" --modal   --width=380 --button="Ok":0
        }
        exit
    ...
    gkeep)
        pkexec env DISPLAY=$DISPLAY XAUTHORITY=$XAUTHORITY rm ${WEBAPP_TARGET}/bin/gkeep ${WEBAPP_TARGET}/applications/gkeep.desktop && {
            rm -r ~/.gkeep
            yad --info  --borders=32 --fixed --center --undecorated --text="O webapp Google Keep foi removido com sucesso!" --modal   --width=380 --button="Ok":0
        } || {
            yad --error --borders=32 --fixed --center --undecorated --text="Não foi possível concluir a remoção do webapp!" --modal   --width=380 --button="Ok":0
        }
        exit
    ...
    cvyou)
        pkexec env DISPLAY=$DISPLAY XAUTHORITY=$XAUTHORITY rm ${WEBAPP_TARGET}/bin/cvyou ${WEBAPP_TARGET}/applications/cvyou.desktop && {
            rm -r ~/.cvyou
            yad --info --borders=32 --fixed --center --undecorated --text="O webapp CV2You foi removido com sucesso!" --modal   --width=380 --button="Ok":0
        } || {
            yad --error --borders=32 --fixed --center --undecorated --text="Não foi possível concluir a remoção do webapp!" --modal   --width=380 --button="Ok":0
        }
        exit
    ...
    github)
        pkexec env DISPLAY=$DISPLAY XAUTHORITY=$XAUTHORITY rm ${WEBAPP_TARGET}/bin/github ${WEBAPP_TARGET}/applications/github.desktop && {
            rm -r ~/.github
            yad --info --borders=32 --fixed --center --undecorated --text="O webapp GitHub foi removido com sucesso!" --modal   --width=380 --button="Ok":0
        } || {
            yad --error --borders=32 --fixed --center --undecorated --text="Não foi possível concluir a remoção do webapp!" --modal   --width=380 --button="Ok":0
        }
        exit
    ...
    gist)
        pkexec env DISPLAY=$DISPLAY XAUTHORITY=$XAUTHORITY rm ${WEBAPP_TARGET}/bin/gist ${WEBAPP_TARGET}/applications/gist.desktop && {
            rm -r ~/.gist
            yad --info --borders=32 --fixed --center --undecorated --text="O webapp Gist foi removido com sucesso!" --modal   --width=380 --button="Ok":0
        } || {
            yad --error --borders=32 --fixed --center --undecorated --text="Não foi possível concluir a remoção do webapp!" --modal   --width=380 --button="Ok":0
        }
        exit
    ...
    glitch)
        pkexec env DISPLAY=$DISPLAY XAUTHORITY=$XAUTHORITY rm ${WEBAPP_TARGET}/bin/glitch ${WEBAPP_TARGET}/applications/glitch.desktop && {
            rm -r ~/.glitch
            yad --info --borders=32 --fixed --center --undecorated --text="O webapp Glitch foi removido com sucesso!" --modal   --width=380 --button="Ok":0
        } || {
            yad --error --borders=32 --fixed --center --undecorated --text="Não foi possível concluir a remoção do webapp!" --modal   --width=380 --button="Ok":0
        }
        exit
    ...
    codepen)
        pkexec env DISPLAY=$DISPLAY XAUTHORITY=$XAUTHORITY rm ${WEBAPP_TARGET}/bin/codepen ${WEBAPP_TARGET}/applications/codepen.desktop && {
            rm -r ~/.codepen
            yad --info --borders=32 --fixed --center --undecorated --text="O webapp CodePen foi removido com sucesso!" --modal   --width=380 --button="Ok":0
        } || {
            yad --error --borders=32 --fixed --center --undecorated --text="Não foi possível concluir a remoção do webapp!" --modal   --width=380 --button="Ok":0
        }
        exit
    ...
    diagrams)
        pkexec env DISPLAY=$DISPLAY XAUTHORITY=$XAUTHORITY rm ${WEBAPP_TARGET}/bin/diagrams ${WEBAPP_TARGET}/applications/diagrams.desktop && {
            rm -r ~/.diagrams
            yad --info --borders=32 --fixed --center --undecorated --text="O webapp Diagrams foi removido com sucesso!" --modal   --width=380 --button="Ok":0
        } || {
            yaf --error --borders=32 --fixed --center --undecorated --text="Não foi possível concluir a remoção do webapp!" --modal   --width=380 --button="Ok":0
        }
        exit
        ;;
    ...
    gforms)
        pkexec env DISPLAY=$DISPLAY XAUTHORITY=$XAUTHORITY rm ${WEBAPP_TARGET}/bin/gforms ${WEBAPP_TARGET}/applications/gforms.desktop && {
            rm -r ~/.gforms
            yad --info --borders=32 --fixed --center --undecorated --text="O webapp Google Forms foi removido com sucesso!" --modal   --width=380 --button="Ok":0
        } || {
            yad --error --borders=32 --fixed --center --undecorated --text="Não foi possível concluir a remoção do webapp!" --modal   --width=380 --button="Ok":0
        }
        exit
    ...
    spark)
        pkexec env DISPLAY=$DISPLAY XAUTHORITY=$XAUTHORITY rm ${WEBAPP_TARGET}/bin/spark ${WEBAPP_TARGET}/applications/spark.desktop && {
            rm -r ~/.spark
            yad --info --borders=32 --fixed --center --undecorated --text="O webapp Adobe Spark foi removido com sucesso!" --modal   --width=380 --button="Ok":0
        } || {
            yad --error --borders=32 --fixed --center --undecorated --text="Não foi possível concluir a remoção do webapp!" --modal   --width=380 --button="Ok":0
        }
        exit
    ...
    canva)
        pkexec env DISPLAY=$DISPLAY XAUTHORITY=$XAUTHORITY rm ${WEBAPP_TARGET}/bin/canva ${WEBAPP_TARGET}/applications/canva.desktop && {
            rm -r ~/.canva
            yad --info  --borders=32 --fixed --center --undecorated --text="O webapp Canva foi removido com sucesso!" --modal   --width=380 --button="Ok":0
        } || {
            yad --error  --borders=32 --fixed --center --undecorated --text="Não foi possível concluir a remoção do webapp!" --modal   --width=380 --button="Ok":0
        }
        exit
    ...
    logomaker)
        pkexec env DISPLAY=$DISPLAY XAUTHORITY=$XAUTHORITY rm ${WEBAPP_TARGET}/bin/logomaker ${WEBAPP_TARGET}/applications/logomaker.desktop && {
            rm -r ~/.logomaker
            yad --info  --borders=32 --fixed --center --undecorated --text="O webapp Logo Maker foi removido com sucesso!" --modal   --width=380 --button="Ok":0
        } || {
            yad --error --borders=32 --fixed --center --undecorated --text="Não foi possível concluir a remoção do webapp!" --modal   --width=380 --button="Ok":0
        }
        exit
    ...
    photoshop)
        pkexec env DISPLAY=$DISPLAY XAUTHORITY=$XAUTHORITY rm ${WEBAPP_TARGET}/bin/photoshop ${WEBAPP_TARGET}/applications/photoshop.desktop && {
            rm -r ~/.photoshop
            yad --info  --borders=32 --fixed --center --undecorated --text="O webapp Photoshop Online foi removido com sucesso!" --modal   --width=380 --button="Ok":0
        } || {
            yad --error  --borders=32 --fixed --center --undecorated --text="Não foi possível concluir a remoção do webapp!" --modal   --width=380 --button="Ok":0
        }
        exit
    ...
    photopea)
        pkexec env DISPLAY=$DISPLAY XAUTHORITY=$XAUTHORITY rm ${WEBAPP_TARGET}/bin/photopea ${WEBAPP_TARGET}/applications/photopea.desktop && {
            rm -r ~/.photopea
            yad --info --borders=32 --fixed --center --undecorated --text="O webapp Photopea foi removido com sucesso!" --modal   --width=380 --button="Ok":0
        } || {
            yad --error  --borders=32 --fixed --center --undecorated--text="Não foi possível concluir a remoção do webapp!" --modal   --width=380 --button="Ok":0
        }
        exit
    ...
    gmeet)
        pkexec env DISPLAY=$DISPLAY XAUTHORITY=$XAUTHORITY rm ${WEBAPP_TARGET}/bin/gmeet ${WEBAPP_TARGET}/applications/gmeet.desktop && {
            rm -r ~/.gmeet
            yad --info  --borders=32 --fixed --center --undecorated --text="O webapp Google Meet foi removido com sucesso!" --modal   --width=380 --button="Ok":0
        } || {
            yad --error  --borders=32 --fixed --center --undecorated --text="Não foi possível concluir a remoção do webapp!" --modal   --width=380 --button="Ok":0
        }
        exit
    ...
    medium)
        pkexec env DISPLAY=$DISPLAY XAUTHORITY=$XAUTHORITY rm ${WEBAPP_TARGET}/bin/medium ${WEBAPP_TARGET}/applications/medium.desktop && {
            rm -r ~/.medium
            yad --info --borders=32 --fixed --center --undecorated --text="O webapp Medium foi removido com sucesso!" --modal   --width=380 --button="Ok":0
        } || {
            yad --error  --borders=32 --fixed --center --undecorated --text="Não foi possível concluir a remoção do webapp!" --modal   --width=380 --button="Ok":0
        }
        exit
    ...
    removerPacote "libreoffice*" | yad --progress --no-cancel --width=380 --button="Ok":0 --modal --borders=32 --fixed --center --undecorated --no-buttons \
      --auto-close --pulsate --progress-text= \
    ...
    function removerPacote(){
        export DEBIAN_FRONTEND="noninteractive"
        pkexec apt remove --purge "$1" -y &&{
            yad --info --borders=32 --fixed --center --undecorated --width=380 --button="Ok":0   \
            --text="O WPS Office foi removido com sucesso!"

        } || {
            yad --error --borders=32 --fixed --center --undecorated  --width=380 --button="Ok":0 \
            --text="Não foi possível concluir a remoção...\nPor favor, tente novamente!"
        }
    }

    removerPacote "wps-office-full" | yad --progress --no-cancel --width=380 --button="Ok":0 --modal --borders=32 --fixed --center --undecorated --no-buttons \
      --auto-close --pulsate --progress-text= \
    ...
    function removerPacote(){
        ...
        pkexec apt remove --purge "$1" -y &&{
            yad --info --width=380 --button="Ok":0  --borders=32 --fixed --center --undecorated   --modal \
            --text="O Brave foi removido com sucesso!" 
    ...
    removerPacote "brave-browser" | yad --progress --no-buttons --no-cancel --borders=32 --fixed --center --undecorated --width=380 --button="Ok":0 --modal \
      --auto-close --pulsate  --progress-text= \
    ...
    function removerPacote(){
        ...
        pkexec apt remove --purge "$1" -y &&{
            ...
            yad --error --modal --no-cancel --width=400 --height=100 --borders=32 --fixed --center --undecorated   --button="Ok":0 \
            --text="Não foi possível concluir a remoção...\nPor favor, tente novamente!"
        }
    }
